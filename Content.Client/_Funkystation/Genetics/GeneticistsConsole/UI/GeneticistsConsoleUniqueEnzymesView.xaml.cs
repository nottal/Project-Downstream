...
public sealed partial class GeneticistsConsoleUniqueEnzymesView : Control
{
    ...
    private void UpdatePrintSaveButtonState()
    {
        if (_selectedMutationId == null)
        {
            ...
            PrintActivatorButton.Text = Loc.GetString("dna-scanner-print-activator");
            PrintMutatorButton.Text = Loc.GetString("dna-scanner-print-mutator");
            SaveMutationButton.Disabled = true;
            return;
        }
        ...
        if (ParentWindow is not null && ParentWindow.IsInjectorPrintOnCooldown(out var secondsRemaining))
        {
            ...
            PrintActivatorButton.Text = text;
            PrintMutatorButton.Text = text;
            PrintActivatorButton.Disabled = true;
            PrintMutatorButton.Disabled = true;
        }
        else
