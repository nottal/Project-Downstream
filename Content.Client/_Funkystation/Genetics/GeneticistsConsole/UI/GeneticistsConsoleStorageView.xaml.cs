...
public sealed partial class GeneticistsConsoleStorageView : Control
{
    ...
    private void UpdateActionButtonsState()
    {
        ...
        if (!hasSelection)
        {
            ...
            StoragePrintActivatorButton.Text = Loc.GetString("dna-scanner-print-activator");
            StoragePrintMutatorButton.Text = Loc.GetString("dna-scanner-print-mutator");
        ...
        if (ParentWindow is not null && ParentWindow.IsInjectorPrintOnCooldown(out var secondsRemaining))
        {
            var text = Loc.GetString("dna-scanner-print-cooldown", ("seconds", secondsRemaining));
            StoragePrintActivatorButton.Text = text;
            StoragePrintMutatorButton.Text = text;
            StoragePrintActivatorButton.Disabled = true;
            StoragePrintMutatorButton.Disabled = true;
        }
        else
    ...
    public void UpdateInjectorPrintCooldown()
    {
        UpdateActionButtonsState();
    }
