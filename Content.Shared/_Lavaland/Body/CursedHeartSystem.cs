...
{
    private static readonly SoundSpecifier HeartbeatSound = new SoundPathSpecifier("/Audio/_Lavaland/heartbeat.ogg");
    ...
    private void OnPump(EntityUid uid, CursedHeartComponent comp, PumpHeartActionEvent args)
    {
        ...
        args.Handled = true;
        _audio.PlayPredicted(HeartbeatSound, uid, uid);
    ...
    private void OnUseInHand(EntityUid uid, CursedHeartGrantComponent comp, UseInHandEvent args)
    {
        ...
        _audio.PlayPredicted(HeartbeatSound, args.User, args.User);
