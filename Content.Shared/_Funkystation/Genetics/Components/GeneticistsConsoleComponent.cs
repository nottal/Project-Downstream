...
public sealed partial class GeneticistsConsoleComponent : Component
{
    ...
    /// <summary>
    /// When DNA injector printing can be used again.
    /// </summary>
    [DataField(customTypeSerializer: typeof(TimeOffsetSerializer))]
    public TimeSpan? InjectorPrintCooldownEnd;
...
public sealed class GeneticistsConsoleBoundUserInterfaceState : BoundUserInterfaceState
{
    ...
    public TimeSpan? InjectorPrintCooldownEnd { get; init; }
    ...
    public GeneticistsConsoleBoundUserInterfaceState(
        ...
        TimeSpan? injectorPrintCooldownEnd = null)
    {
        ...
        InjectorPrintCooldownEnd = injectorPrintCooldownEnd;
    }
}
