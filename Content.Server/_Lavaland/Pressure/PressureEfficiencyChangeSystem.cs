...
public sealed class PressureEfficiencyChangeSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<PressureArmorChangeComponent, InventoryRelayedEvent<DamageModifyEvent>>(OnArmorRelayDamageModify, after: [typeof(SharedArmorSystem)]);
    }
    ...
    private void OnArmorRelayDamageModify(Entity<PressureArmorChangeComponent> ent, ref InventoryRelayedEvent<DamageModifyEvent> args)
    {
        ...
        args.Args.Damage *= Math.Max(0f, 1f + ent.Comp.ExtraPenetrationModifier);
    }
