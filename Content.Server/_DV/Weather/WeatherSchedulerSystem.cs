...
using Content.Shared._DV.Weather;
...
public sealed class WeatherSchedulerSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        {
            if (now < comp.NextUpdate || comp.Stages.Count == 0)
                continue;
            ...
            {
                _weather.SetWeather(mapId, null, comp.NextUpdate);
            }
    ...
    private static bool HasWeather(WeatherSchedulerComponent comp, int stage)
    {
        if (stage < 0)
